...
import MarkdownView, { parseBlocks } from '@/components/markdown-view';
        ...
        {sidebarOpen && (
          <div className="grid gap-0.5 px-2 pt-1.5">
            ...
            >
              ...
              <span>Inbox</span>
              {unreadCount > 0 && (
                <span className="inline-flex items-center justify-center rounded-full bg-violet-500 px-1.5 py-0.5 text-[9px] font-medium text-white min-w-[18px]">
                  {unreadCount > 9 ? '9+' : unreadCount}
                </span>
              )}
              <span className="ml-auto text-[10px] text-[var(--metis-fg-dim)]">⌘I</span>
            </button>
            <button
              type="button"
