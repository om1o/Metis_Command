...
CHECKS: dict[str, Check] = {
    ...
    "tests.backend": Check(
        key="tests.backend",
        description="Focused backend unit tests for the active desktop/browser MVP reliability contracts.",
        command=_py(
            "-m",
            "pytest",
            "tests/unit/test_agent_bus.py",
            "tests/unit/test_auth_local.py",
            "tests/unit/test_brains.py",
            "tests/unit/test_concurrency.py",
            "tests/unit/test_safety.py",
            "tests/unit/test_mts_format.py",
