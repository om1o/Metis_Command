...
| `--no-window`     | Headless — open http://127.0.0.1:7331/splash (same FastAPI process). |
...
| `dynamic_ui.py`           | Legacy Streamlit UI (not started by `launch.py`)  |
| `ui_theme.py`             | Streamlit theme helpers (used only by `dynamic_ui.py`) |
