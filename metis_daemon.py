...
Runs as a long-lived process that keeps the Streamlit UI tucked away
but instantly summonable via Ctrl+Space.  System-tray right-click menu
offers Open / Pause / Restart / Quit.
"""
...
UI_PORT = int(os.getenv("METIS_UI_PORT", "8501"))
...
class Metis:
    ...
    def restart(self) -> None:
        print("[Daemon] restarting Streamlit subprocess…")
